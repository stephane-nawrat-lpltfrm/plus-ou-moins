Énoncé :
Crée un programme en JavaScript qui permet de jouer au jeu du "Plus ou Moins" dans la console du navigateur (via des boîtes de dialogue prompt() ou alert()).
...
Trop petit alors afficher : "C'est plus !"

Trop grand alors afficher : "C'est moins !"

Correct alors afficher : "Bravo ! Tu as trouvé en X tentatives."
